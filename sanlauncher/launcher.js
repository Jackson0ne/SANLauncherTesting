...
document.getElementById("maincont").style.backgroundColor = "red"
            ...
            GetTreeURL().then(treeurl => {
                fetch(treeurl, { cache: "no-store" }).then(response => {
                    ...
                    function DownloadFiles() {
                        ...
                        fetch(`https://cdn.jsdelivr.net/gh/${ghuser}/${ghrepo}@${sha}/version.json`, { cache: "no-store" }).then(res => res.json()).then(data => {
                            var latest = data
                            ...
                            function CheckVersion() {
                                return new Promise(resolve => {
                                    ...
                                    if (repoversion > localversion) {
                                        ...
                                        console.log("TEST", IntToFloat(repoversion))
                    ...
                    fetch(`https://cdn.jsdelivr.net/gh/${ghuser}/${ghrepo}@${sha}/`, { cache: "no-store" }).then(response => {
                        if (response.ok) {
                            return response
                        } else {
