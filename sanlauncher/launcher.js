                            ...
                            function CheckVersion() {
                                return new Promise(resolve => {
                                    ...
                                    if (repoversion > localversion) {
                                        var confirmmsg
                                        if (branch == "beta") {
                                            confirmmsg = `New App Revision (BETA ${(repoversion).toFixed(2)}) available! Do you want to download it?`
                                        } else {
                                            confirmmsg = `New App Revision (${(repoversion).toFixed(2)}) available! Do you want to download it?`
                                        }
