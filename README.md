...
Steam Achievement Notifier - Beta Channel
-
...
Welcome to the **Steam Achievement Notifier Beta Channel**!

Here you'll be able to test out new features being planned for inclusion in future versions of Steam Achievement Notifier, but you are more likely to encounter bugs and stuff, so be warned!

_To download official releases of Steam Achievement Notifier, please visit the main repository [here](https://github.com/steamachievementnotifier/steamachievementnotifier)!_
...
3. When the application opens, click the _Settings_ (⚙) button in the top-left corner. Enter your _API Key_/_Steam64 ID_ and click the "_Save_" button(s). After valid credentials have been saved, your username will be updated.
4. To join the **Beta Channel**, click _Settings_ > **Join Beta Channel**. Once confirmed, the most recent Beta Channel release will be downloaded.
5. If you decide you no longer want to participate in the Beta Channel for any reason, freedom is just three clicks away - open _Settings_, click **Leave Beta Channel** and confirm! When the app restarts, your most recent App Revision backup will be restored from a local backup (so no waiting around for downloads again!)
